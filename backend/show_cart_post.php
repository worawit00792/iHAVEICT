...
d.order_id , COUNT(d.order_id) as coid, SUM(d.total) as ctotal, o.postcode
...
<thead>
  ...
  <?php do { ?>
    <tr>
      ...
      <a href="index.php?order_id=<?php echo $row_mycart['oid']; ?>&pcode=<?php echo $row_mycart['postcode']; ?>&act=show-order" target="_blank">
